...
namespace ProgramFeature.Infrastructure.Data.DbModels
{
    public partial class programfeatureContext : DbContext
    {
        public programfeatureContext()
        {
        }

        public programfeatureContext(DbContextOptions<programfeatureContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-RRK329U;Database=programfeature;Trusted_Connection=True;");
            }
        }
